...
## 7 vLLM Inference Implementation (standalone chapter)
...
### 7.2 Prefill Flow — from hidden state to attention output
...
### 7.3 Decoding Flow — how a single query consumes 1M context
...
### 7.4 Three workstreams — KV Cache, Indexer, MTP (with byte / shape detail)
