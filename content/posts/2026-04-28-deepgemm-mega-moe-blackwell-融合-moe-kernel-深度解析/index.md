...
## 并行分工：16 Warp Specialization 与寄存器动态重分配
...
## 内存层级：从 HBM 到 Register，数据只走一个方向
...
## 数值：FP8×FP4 + UE8M0 + SwiGLU-amax 流水
...
## 其他优化点：Swap A/B · PDL · JIT · FP4 Indexer · Wave Scheduler
...
## 从 Mega MoE 看未来硬件：V4 论文给硬件厂商的 4 条建议
...
## DeepGEMM Mega MoE 完整技术指南（mega_moe_complete_guide.md 全文）
*PR #304 技术报告 · Warp 级流程 · 设计原理 · Barrier 剖析 · 附录 —— 全部 3500 行原文渲染*

## draw.io 四张原图：整体流程 / Warp 时序 / 内存层级 / Warp Barrier 机制
