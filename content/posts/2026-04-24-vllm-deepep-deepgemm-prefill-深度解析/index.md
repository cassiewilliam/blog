...
## HT Dispatch：FP8 化 + NVLink/RDMA 双通路
...
## DeepGEMM Contiguous：-1 padding + m_indices 跳过
...
## HT Combine：BF16 回程 + weighted sum
...
## 后端决策：为什么选 DeepGEMM 而不是 Triton / CUTLASS
*Oracle 在加载期一次性决定*
...
## 📖 完整源码级详解（deep_ep_gemm_prefill_flow_cn.md）
