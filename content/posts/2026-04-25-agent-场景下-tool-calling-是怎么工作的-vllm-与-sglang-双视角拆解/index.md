...
## Agent 场景的 tool calling 在做一件什么事
...
## Prompt 端：tools schema 怎么进 prompt
...
## 输出端：把 token 流解析回 OpenAI 格式 tool_calls
...
## 约束生成：tool_choice 决定 grammar 编不编译
...
## 引擎调度层：tools 怎么影响 prefill / decode 性能
...
## Agent Runtime：loop 在哪里跑、tool 谁来执行、async 怎么协作
