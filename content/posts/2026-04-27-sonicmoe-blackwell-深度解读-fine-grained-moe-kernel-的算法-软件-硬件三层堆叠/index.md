...
- [Repositories ](https://dao-lab.ai/repositories/)
- 
...
📘 中英对照 + 深度解读版
  ...
  阅读前建议先过 👇 下方的背景知识与符号定义，后面所有章节都会引用那里的术语与数字。专业术语（TMA/UMMA/TMEM/WGMMA/MMA/CTA/CLC/SMEM/HBM/PTX/CUTLASS/QuACK/SwiGLU/Hopper/Blackwell/Grouped GEMM 等）保留英文避免歧义。
...
{{< /formula >}}
 ...
 ============ Equivalence proof ============ 🔎 等价性证明：两种方案 bit-exact 产生相同梯度
...
[](https://arxiv.org/abs/2512.14080) [](https://github.com/Dao-AILab/sonic-moe) [](https://pypi.org/project/sonic-moe/)
